...
export function Upload(): JSX.Element {
  ...
  const handleEntityDataChange = (prop: keyof ArtEntityDTO) => (event: React.ChangeEvent<HTMLInputElement>) => {
  ...
  async function createEntity(event: FormEvent) {
    ...
    await artEntityService.createEntity(entityData).then(() => navigate(PagesUriConstnts.IndexUri));
  }
        ...
        <form onSubmit={createEntity}>
          <FormControl sx={{ m: 3 }} component="fieldset" variant="standard">
            <FormGroup>
              ...
              <TextField required name="entity-name" placeholder="Name" value={entityData.name} onChange={handleEntityDataChange('name')} />
            </FormGroup>
            <FormControl>
              <FormGroup>
